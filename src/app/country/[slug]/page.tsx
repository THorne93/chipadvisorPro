...
import { getCountryChips, getCountryRank, getCountryRating } from "@/lib";
...
export default async function CountryPage({ params }: { params: Params }) {
  ...
  const readableCountry = actualParams.slug
    .replace(/-/g, ' ')
  ...
  return (
    <div className="mt-2 border border-black mx-auto w-3/4 rounded-md">
      <div className="my-2 px-4">
        <h1 className="text-3xl py-1 font-bold">{readableCountry}</h1>
